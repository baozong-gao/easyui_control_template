...
<div class="ul-list-page">
    ...
    <form id="searchForm" method="post">
        <div id="searchPanel" class="easyui-panel">
            ...
            <div class="lists">
                ...
                <label style="width: 40px;" for="disableTag">状态：</label>
                <select class="w90  easyui-combobox" name="disableTag" id="disableTag">
    ...
    <table id="listGrid" url="user/search" class="easyui-datagrid" toolbar="#toolbar" singleSelect="false"
        ...
        <tr>
            ...
            <th data-options="field:'disableTag',width:'10%',align:'center'" formatter="fmStatus">状态</th>
        </tr>
        </thead>
    </table>
